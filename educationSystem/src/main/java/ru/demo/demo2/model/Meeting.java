...
public class Meeting {
    ...
    @ManyToOne @JoinColumn(name = "pair_id", nullable = false) private Pair pair;
    @Column(nullable = false) private LocalDateTime datetime;
    private String topic;
    @Column(name = "tasks_done", columnDefinition = "TEXT") private String tasksDone;
    @Column(name = "mentor_rating") private Integer mentorRating;
    @Column(name = "mentee_rating") private Integer menteeRating;
    ...
    public String getTasksDone() { return tasksDone; }
    public void setTasksDone(String tasksDone) { this.tasksDone = tasksDone; }
    ...
    @Override public String toString() { return "Встреча #" + id; }
}
