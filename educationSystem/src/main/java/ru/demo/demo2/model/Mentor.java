...
public class Mentor {
    ...
    @ManyToMany(fetch = FetchType.EAGER) @JoinTable(name = "mentor_directions", joinColumns = @JoinColumn(name = "mentor_id"), inverseJoinColumns = @JoinColumn(name = "direction_id"))
